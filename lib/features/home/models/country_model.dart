...
class CountryData {
  ...
  area: 'Pakistani',
  flagUrl:
      'https://www.themealdb.com/images/icons/flags/big/64/pk.png',
),
    CountryModel(
      name: 'British',
      area: 'British',
    ...
    CountryModel(
      ...
      area: 'Filipino',
      flagUrl:
          'https://www.themealdb.com/images/icons/flags/big/64/ph.png',
    ),
    CountryModel(
      name: 'French',
      area: 'French',
    ...
    CountryModel(
      ...
      area: 'Kenyan',
      flagUrl:
          'https://www.themealdb.com/images/icons/flags/big/64/ke.png',
    ),
    CountryModel(
      name: 'Malaysian',
      area: 'Malaysian',
    ...
    CountryModel(
      ...
      area: 'Ukrainian',
      flagUrl:
          'https://www.themealdb.com/images/icons/flags/big/64/ua.png',
    ),
    CountryModel(
      name: 'Vietnamese',
      area: 'Vietnamese',
